							...
							},
							{
								...
								[
									...
									},
									{
										...
										'default' : '',
										id : 'advStyles',
										validate : function(){return true;},//CKEDITOR.dialog.validate.inlineStyle( editor.lang.common.invalidInlineStyle ),
										setup : setupAdvParams,
										commit : commitAdvParams
									}
								]
		...
		onLoad : function()
		{
			...
			if ( !editor.config.linkShowTargetTab )
				this.hidePage( 'target' );		//Hide Target tab.
                        $('[id$="_textInput"]').value=this.getParentEditor().getSelection().getSelectedText().replace(/^\s+|\s+$/g,'');
