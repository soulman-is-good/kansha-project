...
<?
$models = Page::get(array('parent_id'=>'NULL'));
?>
...
<div class="module-menu-list">
    <? foreach ($models as $model): 
         $childs = Page::get(array('parent_id'=>$model->id));
        ?>
    <div class="list-item" id="page-item-<?=$model->id?>">
    ...
    <div parent-id="page-item-<?=$child->parent_id?>" class="list-item" id="page-item-<?=$child->id?>" style="display:none">
        ...
        <div class="options">
                    <a href="#edit" onclick="call_edit(<?=$child->id?>,'<?=$class?>');return false;"><img alt="edit" src="/images/admin/edit.gif" title="Редактировать" /></a>
                    <a href="#delete" onclick="_deletelist('<?=$child->id?>','<?=$class?>')"><img src="/images/admin/delete.gif" alt="delete" title="Удалить" /></a>
        </div>
    </div>
    <? endforeach; ?>
    <? endforeach; ?>
