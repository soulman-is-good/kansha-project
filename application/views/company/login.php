                ...
                <tbody><tr>
                        <td width="300px">
                            <form action="/company/login.html" method="post" name="company-form-general">
                                ...
                                <?endif?>
                                <div class="gray">
                                    <i>*</i><span class="gray_inside"><b>Логин</b></span>
                                </div>
                                <input type="text" name="login" />
                                <div class="gray">
                                    <i>*</i><span class="gray_inside"><b>Пароль</b></span>
                                </div>
                                <input type="password" name="pass" />

                                <div class="send"><input style="float:none" type="submit" value="Войти" class="photo"></div>
                            </form>
                        </td>
                    </tr>
                </tbody></table>
