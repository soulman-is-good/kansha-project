...
echo $this->renderPartial("@views:admin:templates:default.kansha.php",
        array(
            ...
            'labels'=>array(
                ...
                'status'=>'Видимость',
                'isfree'=>array('@value'=>'Платный пакет','@wrapper'=>'<img title="Услуги" width="32" src="/images/{{=$modules->isfree?\'gstar\':\'ostar\'}}.png" /><img title="Прайслисты" width="32" src="/images/{{=$modules->isfree1?\'gstar\':\'ostar\'}}.png" /><img title="Распродажи" width="32" src="/images/{{=$modules->isfree2?\'gstar\':\'ostar\'}}.png" />'),
                'weight'=>'Порядок',
            ),
            'class'=>$class,
            'actions'=>$actions,
