 ...
 * @author Soul_man
 */
class Shop_Stat extends X3_Module_Table {
    
    public $encoding = 'UTF-8';
    public $tableName = 'shop_stat';
    const KEY = 'X3_Shop_Stat_id';

    public $_fields = array(
        'id'=>array('integer[10]','unsigned','primary','auto_increment'),
        'item_id'=>array('integer[10]','unsigned','primary','ref'=>array('Shop_Item'=>'id','default'=>'title')),
