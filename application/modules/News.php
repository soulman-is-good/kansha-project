...
class News extends X3_Module_Table {
    ...
    public function actionIndex() {
        ...
        SeoHelper::setMeta();
        $this->template->render('index', array('news' => $news,'articles'=>$article,'nc'=>$nc,'ac'=>$ac,'pagnews'=>$pagnews,'pagarts'=>$pagarts,'bread'=>'<span style="top:1px" class="sale">Архив</span>'));
    }
